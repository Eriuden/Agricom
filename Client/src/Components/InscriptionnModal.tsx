        ...
        {formSubmit ? (
          ...
          <form action='' onSubmit={handleRegister} className="bg-slate-100 flex
           ...
           my-4 md:mx-[20%] lg:mx-[20%]">
              ...
              <label htmlFor="typeOfUser" className='mt-2 text-center text-black font-serif'>Quel type d'utilisateur êtes vous ?</label>
              <select value={typeOfUser} onChange={(e)=>setTypeOfUser(e.target.value)}>
                <option value="producter">Producteur</option>
